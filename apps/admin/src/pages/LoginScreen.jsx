...
export default function LoginScreen() {
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <form onSubmit={handleSubmit} style={{ width: '340px', padding: 'var(--space-6)', background: 'var(--color-surface)', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
          ...
          <button type="submit" disabled={isSubmitting} style={{
            padding: 'var(--space-3)', background: 'var(--color-accent)', color: '#fff',
